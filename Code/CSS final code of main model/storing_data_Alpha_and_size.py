...
# "This file stores the grid data by using varing alpha and system size(grid size)."
...
if __name__ == '__main__':
    ...
    num_iterations = 50
    final_grids = {}
    alphas = [1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5]  # Example values for alpha
    grid_sizes = [30, 40, 50, 60, 70, 80, 90, 100, 200, 400]  # Example values for grid size
    growth_rates_C = [0.001]
    ...
    np.savez("final_grids_size_and_alpha.npz", **final_grids)
    print("Final grids saved as final_grids_size_and_alpha.npz")
